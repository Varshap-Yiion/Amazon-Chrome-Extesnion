...
export class AppComponent {
  ...
  downloadCsv() {
    ...
    } else if (this.skucode !== '' && this.profitmargin !== '' && this.exchangedifference !== '')  {
      var head = ['Product Title', 'Price', 'Brand', 'Quantity', 'SKU Code', 'Profit Margin', 'Exchange Difference (CAD)'];
